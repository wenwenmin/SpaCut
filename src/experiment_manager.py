...
class ExperimentManager(object):
    ...
    def get_basic_arg_parser(self):
        ...
        parser.add_argument('--fg_net_epoch', type=int, default=50, help="foreground net training epoch number")
        parser.add_argument('--fg_net_batch_size', type=int, default=128, help="foreground net batch size")
        ...
        parser.add_argument('--cell_net_epoch', type=int, default=50, help="cell net training epoch number")
    ...
    def _set_up_logger(self, level=logging.DEBUG, name="SpaCutModel"):  
        """
